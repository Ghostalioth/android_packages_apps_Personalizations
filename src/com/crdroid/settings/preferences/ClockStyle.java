...
public class ClockStyle extends RelativeLayout {
    ...
    private static final int[] CLOCK_VIEW_IDS = {
            ...
            R.id.keyguard_anci_clock_outline,
            R.id.keyguard_anci_clock_ovalium,
            R.id.keyguard_anci_clock_rectangle,
            R.id.keyguard_anci_clock_wallet,
            R.id.keyguard_anci_clockdate_clavicula,
            R.id.keyguard_anci_clockdate_kln,
            R.id.keyguard_anci_clockdate_miring,
            R.id.keyguard_anci_clockdate_scapula,
            R.id.keyguard_anci_clockdate_sternum,
            R.id.keyguard_sparkCircle,
            R.id.keyguard_sparkList,
